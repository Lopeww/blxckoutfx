...
public class PatchouliWordMixin {
    ...
    private Component blxckoutfx$adjustPatchouliWordTextColor(Component component) {
        return adjustPatchouliWordTextColor(component);
    }
    ...
    private Component blxckoutfx$adjustObfuscatedPatchouliWordTextColor(Component component) {
        return adjustPatchouliWordTextColor(component);
    }
    ...
    private Component blxckoutfx$adjustIntermediaryPatchouliWordTextColor(Component component) {
        return adjustPatchouliWordTextColor(component);
    }

    private static Component adjustPatchouliWordTextColor(Component component) {
